...
Module = (function() {
  function Module(id, dependencies, factory) {
    ...
    if (Object.prototype.toString.call(this.dependencies) !== '[object Array]') {
      this.factory = this.dependencies;
      this.dependencies = defaultDependencies.slice(0, ((_ref = this.factory) != null ? _ref.length : void 0) || 0);
    }
    if (!this.factory) {
  ...
  Module.prototype.getCurrentScript = function() {
    ...
    if (document.currentScript) {
      ...
      if (stack) {
        ...
        for (_j = 0, _len1 = eles.length; _j < _len1; _j++) {
          ele = eles[_j];
          if (ele.src === url) {
            return ele;
          }
  ...
  Module.prototype.getPreloadDependencies = function() {
    var dep, deps, fnstr, implicitDependencies, _i, _len, _ref;
    ...
    deps = [];
    _ref = this.dependencies.concat(implicitDependencies || []);
  ...
  Module.prototype.resolveDependenceId = function(id) {
    var dots, key, m, map, parentId, value, wildMap, _ref, _ref1;
    parentId = this.id;
...
require.config = function(options) {
  var dots, k, key, v, value, _ref, _ref1, _results;
  _results = [];
  for (key in options) {
    ...
    switch (key) {
      ...
      case 'paths':
        ...
        break;
      case 'map':
        config.map = (_ref1 = config.map) != null ? _ref1 : {};
        _results.push((function() {
          var _results1;
          _results1 = [];
          for (k in value) {
